...
const SearchBox = () => {
    ...
    const mySwitchAirline = (airlinesCode) => {
        switch (airlinesCode) {
            ...
            case 'IB':
                return `https://www.iberia.com/flights/?market=ES&language=es&appliesOMB=false&splitEndCity=false&initializedOMB=true&flexible=true&TRIP_TYPE=1&BEGIN_CITY_01=${originIata}&END_CITY_01=${destinationIata}&BEGIN_DAY_01=${selectDate.substring(
                    6,
                    8,
                )}&BEGIN_MONTH_01=${selectDate.substring(
                    0,
                    6,
                )}&BEGIN_YEAR_01=${selectDate.substring(
                    0,
                    4,
                )}&END_DAY_01=&END_MONTH_01=&END_YEAR_01=&FARE_TYPE=R&quadrigam=IBHMPA&ADT=${numPassengers}&CHD=0&INF=0&BNN=0&YTH=0&YCD=0&residentCode=&familianumerosa=&BV_UseBVCookie=no&boton=Buscar&bookingMarket=ES#!/availability`;
        }
    };
        ...
        <div className={styles.__wrapper}>
            ...
            <div className={styles.__container}>
                <div className={styles.__inputBox}>
                    <label className={styles.__label}>Desde</label>
                    <br />
                    <select
                ...
                <div className={styles.__inputBox}>
                    <label className={styles.__label}>A</label>
                    <br />
                    <select
                ...
                <div className={styles.__inputBox}>
                    <label className={styles.__label}>Compañía</label>
                    <br />
                    <select
                        className={`${styles.__select} ${styles.__airline}`}
                        value={airlinesCode}
                        onChange={(e) => {
                            setAirlinesCode(e.target.value);
                        }}
                    >
                        ...
                        {airlines &&
                            airlines.map((airline) => {
                                ...
                                return (
                                    <option key={id} value={two_letter_code}>
                                        {name}
                                    </option>
                                );
                            })}
                ...
                <div className={styles.__inputBox}>
                    <label className={styles.__label}>Salida</label>
                    <br />
                    <select
                ...
                <a className={styles.__button} target="_blank" href={mySwitchAirline(airlinesCode)}>
                    Ver Vuelos &rarr;
                </a>
                {/* <a
